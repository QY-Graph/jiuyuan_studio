...
export const stylesheets = [
  {
    selector: 'node',
    style: {
      width(ele) { return ele ? ele.data('size') / 2 : 35; },
      height(ele) { return ele ? ele.data('size') / 2 : 35; },
      label(ele) {
      ...
      'font-size': '10px',
      'text-wrap': 'ellipsis',
      'text-max-width': function (ele) { return ele ? ele.data('size') / 2 : 35; },
    },
  },
  {
  ...
  },
  {
    selector: 'edge',
    style: {
      width(ele) { return ele ? ele.data('size') / 2 : 1; },
